...
const languagesDetectorOption = {
  ...
  lookupQuerystring: process.env.I18N_QUERY,
  lookupCookie: process.env.I18N_COOKIE_NAME,
  lookupLocalStorage: process.env.I18N_STORAGE,
        ...
        .init(
          {
            ...
            ns: [process.env.I18N_NS],
            defaultNS: process.env.I18N_NS,
            debug: config.debug,
            interpolation: {
